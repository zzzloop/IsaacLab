...
parser.add_argument("--normalized_gripper", action="store_true", default=True, help="Map model gripper outputs from closedness [0, 1] to jaw target meters before sending to BRX.")
...
parser.add_argument("--invert_gripper", action="store_true", help="Diagnostic: invert model gripper output before scaling.")
...
parser.add_argument("--gripper_gamma", type=float, default=1.0, help="Power applied to normalized closedness before scaling. Use <1 if the model is under-closing.")
